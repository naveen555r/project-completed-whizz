...
const CategoryWiseProductDisplay = ({category,heading}) => {
  ...
  return (
    <div className='container mx-auto px-4 py-1 relative '>
        ...
        <div className='grid grid-[repeat(auto-fit,minmax(300px,320px))] justify-between gap-4 overflow-x-scroll scrollbar-none'>
                        ...
                        return(
                            <Link to={"product/"+product?._id} className='w-full min-w-[280px] max-w-[280px] bg-white rounded-sm shadow'>
                                    ...
                                    <div className='p-4 grid gap-3 items-center '>
                                        ...
                                        <button className='bg-blue-500 hover:bg-blue-600 text-white text-sm py-0.5 px-3 rounded-full 'onClick={(e)=>addToCart(e,product?._id)}>Add to cart</button>    
